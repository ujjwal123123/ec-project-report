...
\begin{figure}[h]
      ...
      \caption{The node with identifier 0011 stores information about nodes in
            four subtrees which are encircled.
            \cite{petarmaymounkovKademliaPeertoPeerInformation2002}}
...
have limitations, e.g. \mynote{what are the limitations?}
